...
import { FeedQuery } from "../Layout/AppShell";
                        ...
                        return (
                          <button
                            ...
                            className={`cursor-pointer group flex w-full items-center justify-between gap-4 rounded-2xl border px-4 py-5 text-left transition hover:bg-[var(--bg-dark-green)]/6 hover:border-[var(--primary-green)]/40 transition-all duration-200  ${
                              isActive ? "border-[var(--primary-green)]/40 bg-[var(--bg-dark-green)]/6 text-[var(--text-primary)]" : "border-[var(--border)]/10 hover:border-[var(--primary-green)]/20"
                            }`}
                          >
                            <div className="flex items-center gap-4">
                                <div className={`flex h-8 w-8 rotate-45 items-center justify-center rounded-lg text-xs font-semibold text-[var(--text-secondary)] group-hover:text-white group-hover:bg-[var(--bg-dark-green)] transition-colors duration-200 ${isActive ? "bg-[var(--bg-dark-green)] text-white" : "bg-[var(--surface-secondary)]"}`}>
                    ...
                    {filteredJuzs.map((juz) => {
                      ...
                      return (
                        <div key={juz.id} className="flex flex-col gap-2">
                          ...
                          >
                            <div className="flex items-center gap-4">
                              <div className={`flex h-8 w-8 rotate-45 items-center justify-center rounded-lg text-xs font-semibold text-[var(--text-secondary)] group-hover:text-white group-hover:bg-[var(--bg-dark-green)] transition-colors duration-200 ${isActive || isExpanded ? "bg-[var(--bg-dark-green)] text-white" : "bg-[var(--surface-secondary)]"}`}>
                                <span className="-rotate-45">{juz.juz_number}</span>
                              </div>
                              <div>
                                <p className="text-sm font-semibold pb-1">Juz {juz.juz_number}</p>
                                <p className="text-xs text-[var(--text-secondary)]">{firstSurah?.transliteration} & More</p>
                              </div>
                            </div>
                            <div className="flex items-center gap-2">
                              <span className="text-xs text-[var(--text-secondary)] font-medium">الجزء</span>
                            ...
                            {isExpanded && (
                              ...
                              >
                                <div className="pl-6 flex flex-col gap-2 pb-2">
                                  <button
                                    onClick={() => {
                                      if (onJuzSelect) onJuzSelect(juz.juz_number);
                                      onClose();
                                    }}
                                      ...
                                      return (
                                        ...
                                        >
                                          <div className="flex items-center gap-3">
                                            ...
                                            <span className="text-xs font-medium text-[var(--text-primary)]">{s.transliteration}</span>
                                          </div>
                                          <span className="text-xs text-[var(--text-secondary)] font-[var(--font-calligraphy)]">{s.name}</span>
                                        </button>
                                      );
                                    })}
                                  </div>
                       ...
                       return (
                        ...
                        >
                          <div className="flex items-center gap-4">
                            ...
                            <div>
                              <p className="text-sm font-semibold pb-1">Page {page}</p>
                              <p className="text-xs text-[var(--text-secondary)]">Reading Page</p>
                            </div>
                          </div>
                          <span className="text-xs text-[var(--text-secondary)] font-medium">صفحة</span>
                        </button>
                      );
                    })}
                  </div>
